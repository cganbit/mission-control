...
**Login padrão:** admin / openclaw2024 (criado automaticamente no primeiro acesso)
...
ssh.connect('187.77.43.141', username='root', password='@Bolota1199@')
...
for cmd in [
    ...
    'docker run -d --name mission-control --restart unless-stopped -p 3001:3001 -e DATABASE_URL="postgresql://evolution:rRbUmQvIwduoclyN1gA5gI4RWVzYC1GQ@postgres:5432/mission_control" -e JWT_SECRET="mission-control-super-secret-key-2024-change-this" -e ADMIN_PASSWORD="openclaw2024" --network evolution-api-h4pg_default mission-control:latest',
