...
- [ ] Schema markup valid (JSON-LD preferred)
- [ ] `hreflang` correto (se multi-idioma)

## Content SEO Checklist

- [ ] Title tags optimized (50-60 chars)
- [ ] Meta descriptions (150-160 chars)
- [ ] H1-H6 hierarchy correct (1 H1 por página)
- [ ] Internal linking structure
- [ ] Image alt texts
- [ ] URLs semânticas e estáveis
...
```yaml
SEO_STATUS: pass | issues_found | fixed | partial
ISSUES_FOUND:
  - type: "technical | content | geo | vitals"
    severity: critical | high | medium | low
    description: "[descrição]"
    page: "[página afetada]"
FIXES_APPLIED:
  - issue: "[issue corrigido]"
    file: "[arquivo]"
    change: "[mudança aplicada]"
FILES_MODIFIED:
  - "[arquivo ou lista vazia]"
CORE_VITALS_STATUS: pass | fail | not_measured
```

**Regras do output:**
- `SEO_STATUS: fixed` → `FIXES_APPLIED` deve ter pelo menos 1 item
- `SEO_STATUS: pass` → `ISSUES_FOUND` deve ser `[]`
- **Nunca omitir estes 3 campos** (`SEO_STATUS`, `ISSUES_FOUND`, `FIXES_APPLIED`)
